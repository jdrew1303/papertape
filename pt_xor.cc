...
/*!
 * \file
 * \brief Main entry point of papertape XOR operator executable.
 *
 */ 
...
void PrintHelp(ostream& os) {
    ...
    os << endl;
    os << "Usage:" << endl;
    os << "  pt_xor [-v] <file1> <file2>"
       << endl;
    os << endl;
    os << "Description:" << endl;
    os << "  pt_xor reads data from two input files, computes the bitwise XOR, and" << endl;

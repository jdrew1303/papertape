...
/*!
 * \file
 * \brief Main entry point of papertape AND operator executable.
 *
 */ 
...
void PrintHelp(ostream& os) {
    ...
    os << endl;
    os << "Usage:" << endl;
    os << "  pt_and [-v] <file1> <file2>"
       << endl;
    os << endl;
    os << "Description:" << endl;
    os << "  pt_and reads data from two input files, computes the bitwise AND, and" << endl;
